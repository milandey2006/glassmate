      ...
      <div className="mt-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 w-120 mx-auto">
              Where a chai-fueled idea turned into a media movement. <br></br>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-7xl font-bold mb-8 text-white leading-tight">
                ...
                <span
                  className="text-sage-400 italic font-light block mt-2"
                  style={{ color: "#6B8E73" }}
                >
            ...
            <div className="space-y-16">
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                >
                  <div className="relative bg-slate-800/25 backdrop-blur-sm border border-slate-600/30 rounded-3xl p-12 h-full transition-all duration-500 group-hover:bg-slate-800/35 group-hover:border-slate-500/50 group-hover:shadow-2xl group-hover:shadow-slate-900/30">
                    <div
                      className="absolute top-6 right-6 w-20 h-20 bg-sage-500/10 rounded-full opacity-50 group-hover:opacity-100 transition-opacity duration-500"
                      style={{
                        backgroundColor: "#6B8E73",
                        opacity: hoveredSection === "who" ? "0.1" : "0.05",
                      }}
                    ></div>

                    <h2
                      className="text-4xl font-bold mb-8 text-white group-hover:text-sage-200 transition-colors duration-300"
                      style={{
                        color: hoveredSection === "who" ? "#8FA68E" : "white",
                      }}
                    >
                      Who We Are
                    </h2>
                    <p className="text-gray-300 leading-relaxed text-lg group-hover:text-gray-200 transition-colors duration-300">
                      Based in Mumbai, GlassMate Media transforms ideas into
                      high-impact visuals and strategy-first storytelling. Born
                      from lived experience, we&apos;re not just a team —
                      we&apos;re a studio shaped by every real-world lesson the
                      founder learned the hard way.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="relative bg-slate-800/25 backdrop-blur-sm border border-slate-600/30 rounded-3xl p-8 h-full transition-all duration-500 group-hover:bg-slate-800/35 group-hover:border-slate-500/50 group-hover:shadow-2xl group-hover:shadow-slate-900/30">
                    <div
                      className="absolute bottom-6 left-6 w-16 h-16 bg-terracotta-500/10 rounded-full opacity-50 group-hover:opacity-100 transition-opacity duration-500"
                      style={{
                        backgroundColor: "#C17B5A",
                        opacity: hoveredSection === "why" ? "0.1" : "0.05",
                      }}
                    ></div>

                    <h2
                      className="text-2xl font-bold mb-6 text-white group-hover:text-terracotta-200 transition-colors duration-300"
                      style={{
                        color: hoveredSection === "why" ? "#D19B7C" : "white",
                      }}
                    >
                      Why &apos;GlassMate&apos;?
                    </h2>
                    <div className="space-y-4 text-gray-300">
                      <p className="text-sm leading-relaxed group-hover:text-gray-200 transition-colors duration-300">
                        Great media should be like glass — clear, reflective,
                        and real.And every brand deserves a creative partner
                        that&apos;s collaborative, transparent, and rooted in
                        purpose.
                      </p>
                      {/* <p className="text-sm leading-relaxed group-hover:text-gray-200 transition-colors duration-300">
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                >
                  <div className="relative bg-slate-800/25 backdrop-blur-sm border border-slate-600/30 rounded-3xl p-8 h-full transition-all duration-500 group-hover:bg-slate-800/35 group-hover:border-slate-500/50 group-hover:shadow-2xl group-hover:shadow-slate-900/30">
                    <div
                      className="absolute top-6 right-6 w-16 h-16 bg-teal-500/10 rounded-full opacity-50 group-hover:opacity-100 transition-opacity duration-500"
                      style={{
                        backgroundColor: "#6B9B9B",
                        opacity: hoveredSection === "clients" ? "0.1" : "0.05",
                      }}
                    ></div>

                    <h2
                      className="text-2xl font-bold mb-6 text-white group-hover:text-teal-200 transition-colors duration-300"
                      style={{
                        color:
                          hoveredSection === "clients" ? "#8BB0B0" : "white",
                      }}
                    >
                      Our Clients Include
                    </h2>
                    <ul className="space-y-2 text-gray-300">
                      {clientTypes.map((client, index) => (
                        ...
                        >
                          <div
                            className="w-1.5 h-1.5 bg-teal-400/60 rounded-full group-hover:bg-teal-400 transition-colors duration-300"
                            style={{
                              backgroundColor:
                ...
                >
                  <div className="relative bg-slate-800/25 backdrop-blur-sm border border-slate-600/30 rounded-3xl p-12 h-full transition-all duration-500 group-hover:bg-slate-800/35 group-hover:border-slate-500/50 group-hover:shadow-2xl group-hover:shadow-slate-900/30">
                    <div
                      className="absolute bottom-6 left-6 w-20 h-20 bg-rose-500/10 rounded-full opacity-50 group-hover:opacity-100 transition-opacity duration-500"
                      style={{
                        backgroundColor: "#B5838D",
                        opacity: hoveredSection === "what" ? "0.1" : "0.05",
                      }}
                    ></div>

                    <h2
                      className="text-4xl font-bold mb-8 text-white group-hover:text-rose-200 transition-colors duration-300"
                      style={{
                        color: hoveredSection === "what" ? "#C599A3" : "white",
                      }}
                    >
                      What We Do
                    </h2>
                    <p className="text-gray-300 leading-relaxed text-lg group-hover:text-gray-200 transition-colors duration-300">
                      GlassMate Media delivers full-spectrum creative and
                      digital solutions. From powerful video products to social
                      media that speaks your brand language, every service is
                      crafted with intent. We help founders and leaders build
                      personal brands, consult on media strategy, drive digital
                      marketing, and develop websites that convert. Whether
                      it&apos;s crushing it on YouTube or scaling an online
                      presence, GlassMate partners with you to make content that
                      works.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-slate-800/30 via-slate-800/20 to-slate-800/30 backdrop-blur-sm border border-slate-600/30 rounded-3xl p-16 hover:bg-slate-800/40 hover:border-slate-500/50 transition-all duration-500">
                  <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-6">
                      <h2 className="text-4xl lg:text-4xl font-bold text-white leading-tight w-full">
                        Grounded in empath: <br />
                        <span
                      ...
                      <div
                        className="w-16 h-1 bg-sage-500 rounded-full"
                        style={{ backgroundColor: "#6B8E73" }}
                      ></div>
                      ...
                      <p className="text-lg text-gray-300 leading-relaxed">
                        It is a creative collective built on years of real
                        experience and mindful evolution.
                      </p>
                    </div>
                    ...
                    <div className="space-y-8">
                      <div className="space-y-6">
                        ...
                        <p className="text-white font-semibold transition-colors duration-300">
                          And where every project is handled with care and
                          intention.
                        </p>
                        <p className="text-white font-semibold transition-colors duration-300">
                          From humble beginnings to a trusted partner for many
                          brands.
                        </p>
                      </div>
                      ...
                      <div className="pt-6 border-t border-slate-600/30">
                        <p className="text-xl text-white">
                          <strong>
                            Today, we continue this journey with every client,
                            <br></br> team member, and story we&apos;re honored
                            to tell.
                          </strong>
                        </p>
                      </div>
                      <div className="pt-2 border-t border-slate-600/30">
                        ...
                        <ul className="mt-6 grid flex flex-col  justify-items-start space-y-2 text-gray-300 text-center list-none">
                          <li> Clarity - in message and media</li>
                          <li> Intent - strategy behind every story</li>
                          <li> Partnership - not service, but co-creation</li>
                        </ul>

                        {/* CTA Block */}
                        <div className="mt-8 text-center">
                          <h3 className="text-2xl font-bold text-white mb-3">
                            Let&apos;s Co-Create Your Brand&apos;s Next Big Chapter
                          </h3>
                          <Link href={"/contact"}>
                          <button
                            className="bg-sage-500 hover:bg-sage-600 text-white font-semibold py-2 px-6 rounded-full transition-all duration-300 cursor-pointer"
                            style={{ backgroundColor: "#6B8E73" }}
                          >
