...
export default function ContactComponent() {
  ...
  const validateForm = () => {
    ...
    if (
      ...
      (formData.message.length < 20 || formData.message.length > 500)
    ) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
      <div className="container mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-2 sm:col-1 gap-16 items-center max-w-7xl mx-auto">
          {/* LEFT CONTENT */}
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-300 leading-relaxed max-w-lg">
              When you connect with us, you speak directly with a creative
              strategist. No pushy sales talk, just honest ideas.
            </p>
            <div className="flex flex-col gap-4 pt-8 w-full">
              {/* Email - on top */}
              <div className="flex items-center gap-3 text-gray-400 hover:text-blue-400 transition-colors cursor-pointer w-full">
                ...
                <span className="text-sm break-all flex-1">
                  <a href="mailto:info@glassmatemedia.com">
              ...
              <div className="flex items-center gap-3 text-gray-400 hover:text-blue-400 transition-colors cursor-pointer w-full">
                ...
                <span className="text-sm font-semibold break-all flex-1">
                  +91 809 780 3740
                </span>
              </div>
            </div>
          ...
          <div className="lg:pl-8 mt-12">
            <form
              ...
              noValidate
              className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 shadow-2xl space-y-4"
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full mt-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl disabled:opacity-50 cursor-pointer"
              >
